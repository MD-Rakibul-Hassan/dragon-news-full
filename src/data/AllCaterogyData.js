const initalData = [
	{
		...
		category_id: "1",
		rating: { number: 3.5, badge: "Excellent" },
		total_view: 488,
		title:
	...
	},
	{
		...
		category_id: "3",
		rating: { number: 1.5, badge: "Excellent" },
		total_view: 488,
		title:
			"Biden Pledges Nearly $3 Billion To Ukraine In Largest U.S. Military Aid Package Yet",
		author: {
	...
	},
	{
		...
		category_id: "2",
		rating: { number: 5.3, badge: "Excellent" },
		total_view: 400,
		title: "Tucker Carlson Swears Vladimir Putin Is Winning The War In Ukraine",
		author: {
			name: "Jennifer Wood",
	...
	},
	{
		...
		category_id: "1",
		rating: { number: 2.5, badge: "Excellent" },
		total_view: 980,
		title: "Joe Biden announces $3 billion in Ukraine weapons aid",
		author: {
			name: "system",
...

	{
		...
		rating: { number: 2.5, badge: "Excellent" },
		total_view: null,
		title: "Tucker Carlson: Putin Winning in Ukraine, Biden Hurting West",
		author: {
			name: null,
		...
		image_url: "https://i.ibb.co/BZZ5WKv/unsplash-Eh-Tc-C9s-YXsw-4.png",
		details:
			"Fox News's top-rated host, Tucker Carlson, claimed on Monday night that Russian President Vladimir Putin is in fact winning the war in Ukraine, and President Joe Biden's insistence that Putin surrenders his campaign to take over Ukraine is actually evidence Biden's ultimate goal is to 'destroy the West.' Carlson arrived at his bizarre claim after railing against European and American military aid to Ukraine. 'Italy's Ukraine funding is a lot, but it's not quite as much as France. France has sent more than $2 billion U.",
	},
];
